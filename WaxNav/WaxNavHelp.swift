...
class WaxNavHelpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        4. Click the Sort button to control the order of search results.
        ...
        2. You want to perform a wildcard search on a feature name. Use the wildcard SQL symbol %. For example to search for Mount Umunhum you can enter %um%.\n
        3. You want to find a feature using the iPhone's compass. Point the top of your iPhone screen in the direction of the landscape you want to identify. Click the Heading Search button to lock into your heading. To unlock the Heading Search and resume the compass display, click the Heading Search button again.\n
        4. You know the exact longitude and latitude of a location. Enter the latitude and longitude in the search field. Use decimal degrees for each.\n
        5. You know the exact bearing to your location. Rotate the top of your iPhone until the compass displayed matches your desired bearing. Click the Heading Search button to lock into your bearing. To unlock the Heading Search and resume the compass display, click the Heading Search button again.
